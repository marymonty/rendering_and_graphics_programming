...
void DXApp::InitDemo()
{
	...
	SimpleVertex vertices[] =
	{
		...
		// we can no longer repeat verticies to make the central yellow square
		// since the vertices are different due to their different colors

		// GREEN north pointing triangle
		{ Vect(0.0f, 1.0f, 0), Colors::Lime },	// Top 
		{ Vect(0.25f, 0.25f, 0), Colors::Lime },	// Bottom right 
		{ Vect(-0.25f, 0.25f, 0), Colors::Lime },	// Bottom left 

		// MAGENTA south pointing triangle
		{ Vect(0.0f, -1.0f, 0), Colors::Magenta },	// Top
		{ Vect(0.25f, -0.25f, 0), Colors::Magenta },	// Bottom right 
		{ Vect(-0.25f, -0.25f, 0), Colors::Magenta },	// Bottom left  

		// RED east pointing triangle
		{ Vect(1.0f, 0.0f, 0), Colors::Red },	// Top
		{ Vect(0.25f, 0.25f, 0), Colors::Red },	// Bottom left
		{ Vect(0.25f, -0.25f, 0), Colors::Red },	// Bottom right

		// BLUE west pointing traingle
		{ Vect(-1.0f, 0.0f, 0), Colors::Blue },	// Top
		{ Vect(-0.25f, 0.25f, 0), Colors::Blue },	// Bottom left
		{ Vect(-0.25f, -0.25f, 0), Colors::Blue },	// Bottom right

		// YELLOW center square is at the same verts as north trianges bottom points
		// and south triangles bottom points, but needs redeclaration to be Yellow
		{ Vect(0.25f, 0.25f, 0), Colors::Yellow },	// top right 
		{ Vect(-0.25f, 0.25f, 0), Colors::Yellow },	// top left 
		{ Vect(-0.25f, -0.25f, 0), Colors::Yellow },	// Bottom left 
		{ Vect(0.25f, -0.25f, 0), Colors::Yellow }	// Bottom right
	};
