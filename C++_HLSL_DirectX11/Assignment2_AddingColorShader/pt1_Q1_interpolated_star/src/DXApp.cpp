...
void DXApp::InitDemo()
{
	...
	SimpleVertex vertices[] =
	{
		...
		// all the bottom verts (square verts) are YELLOW
		...
		// the center square can be made up of north trianges bottom points
		// and south triangles bottom points
	};
	...
	// updating number of verts to be 12 
	...
	WORD indices[] = 
		{
			...
			1, 2, 5,	// upper center triangle
			1, 5, 4		// lower center tirangle
		};
