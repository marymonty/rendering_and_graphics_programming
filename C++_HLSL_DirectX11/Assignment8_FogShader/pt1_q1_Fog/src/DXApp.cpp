...
void DXApp::InitDemo()
{
	...
	mCam.setOrientAndPosition(Vect(0, 1, 0), Vect(0, 0, 0), Vect(-5, 5, -10) );
...
void DXApp::DrawScene()
{
	...
	pShaderColLight->SendWorldAndMaterial(planeMat, Colors::LightGreen, 1 * Colors::LightGreen, Vect(.7, .7, .7, 150));
	pPlane->Render(md3dImmediateContext);
	pShaderColLight->SendWorldAndMaterial(planeMat2, Colors::LightGreen, 1 * Colors::LightGreen, Vect(.7, .7, .7, 150));
	pPlane->Render(md3dImmediateContext);
