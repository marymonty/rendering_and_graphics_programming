...
void ShaderColorLightTexture::SetTextureResourceAndSampler(Texture* tex)
{
...
void ShaderColorLightTexture::SetPointLightParameters(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
