...
private:	
	...
	//GraphicObject_Texture* GraphObj3;
	//GraphicObject_Texture* GraphObj4;
	//GraphicObject_Texture* GraphObj5;
	//GraphicObject_Light* GraphObj3;
	//GraphicObject_Light* GraphObj4;
	Texture* pTex1;
	Texture* pTex2;
	Texture* pTex3;

	// MARY
	// added a ShaderColorLight pointer, as well as my GraphicObject_Light
	// object pointers
	GraphicObject_TexLight* GraphObj3;
	GraphicObject_TexLight* GraphObj4;
