...
void DXApp::InitDemo()
{
	...
	GraphObj3 = new GraphicObject_Light(pShaderColLight, pModel1);
	GraphObj4 = new GraphicObject_Light(pShaderColLight, pModel2);
...
void DXApp::DrawScene()
{
	...
	// MARY
	// change to our light shaders then render our lit graphic objects
	...
	pShaderColLight->SetSpotLightParameters(Vect(1, 0, 4), 4000, .5 * Vect(1, 0, 0),
