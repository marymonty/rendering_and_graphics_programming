...
// MARY
// SendWVPColor
// calls UpdateSubresource using the function parameters and internal VP Matrix
// @params:
//		world : the world matrix
//		col : the Color vect selected
void ColorSelected3DOptimized::SendWVPColor(const Matrix& world, const Vect& col)
{
	Data_WVPColor wc;
	wc.WVP = world * ViewProj;
	wc.Color = col;
...
// MARY
// SetViewProj
// sets the private ViewProj matrix to be used for internal multiplication
// in our SendWVPColor function
void ColorSelected3DOptimized::SetViewProj(const Matrix& view, const Matrix& proj)
{
	ViewProj = view * proj;
}
