...
public:
	...
	// MARY
	// need our new Create function to make the six face textured unit box
	static void CreateUnitBoxSixFaceTexture(StandardVertex*& pVerts, int& nverts, TriangleByIndex*& pTriList, int& ntri);
	static void CreateSkyBoxTexture(StandardVertex*& pVerts, int& nverts, TriangleByIndex*& pTriList, int& ntri);
