...
void ShaderColorMultiLight::SetPointLightParameters(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLight::SetSpotLightParameters(const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLight::SendFogParameters(float start, float range, const Vect& color)
{
	CBFog myFog;
