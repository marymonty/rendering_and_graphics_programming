...
public:
	...
	static void CreateUnitTexSphere(int vslice, int hslice, StandardVertex *&pVerts, int& nverts, TriangleByIndex *&pTriList, int& ntri);

	
};

Vect normalizePyramidSides(Vect v1, Vect v2, Vect v3);
